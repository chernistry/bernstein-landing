...
**Any CLI agent.** Bernstein ships with 18 adapters: Claude Code, Codex, Gemini CLI, OpenAI Agents SDK, Aider, Cursor, Amp, Kiro, Kilo, Qwen, Goose, and more. If your agent has a CLI, you can write an adapter in under 100 lines. Agents are treated as interchangeable workers, not special snowflakes.
