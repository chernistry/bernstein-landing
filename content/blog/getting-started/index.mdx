...
Bernstein needs at least one CLI coding agent installed. The fastest setup uses Claude Code, but [18 agents are supported](https://bernstein.readthedocs.io/en/latest/ADAPTER_GUIDE/) including Codex, Gemini CLI, the OpenAI Agents SDK, Aider, and more.
