...
Description: Bernstein is an open-source multi-agent orchestration system for AI coding agents. It coordinates Claude Code, Codex, Gemini CLI, and 26 other agents to work in parallel on a codebase using deterministic scheduling, git worktree isolation, and quality gates.
